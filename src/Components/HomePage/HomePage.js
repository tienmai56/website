...
const quotes = [
  ...
  {
    image: "https://raw.githubusercontent.com/shecodesvietnam/asserts/master/2020/staffs/HN/PM_Nguyen_Vu_Ngan_Ha.jpg",
...
const HomePage = (props) => {
  ...
  return (
    <Box margin="6rem auto auto auto" padding="0">
      ...
      <Box as="article" margin="0" padding="10rem 0 25rem 0" backgroundColor="#000">
        <ColorfulText
          as="h2"
          display="block"
            ...
            features.map((value, index) => {
              return (
                <Box 
                  ...
                  width="50%" 
                  padding="0 2%" 
                  maxWidth margin="8rem auto 0 auto"
                  smallWidth="90%"
                >
                  <NormalText
                    as="div"
      ...
      >
        ...
        <FlexBox margin="8rem auto 0 auto" smallMargin="6rem auto 0 auto" maxWidth>
        {
