...
const featuresTechMarathonText = 'Chuỗi các lớp học "crash course" trong vòng 3 ngày, tập trung vào hai mảng: Kỹ năng lập trình (Technical skills) & Định hướng nghề nghiệp (Career Exploration).';
const featuresHackathonText = 'Cuộc thi lập trình dành riêng cho phái nữ đầu tiên tại Việt Nam, bao gồm không gian hack truyền thống cũng như hội thảo & thảo luận với các diễn giả. Dành cho cả coder và non-coder';
const featuresITFairText = 'Chương trình nhằm hỗ trợ trang bị kỹ năng nghề nghiệp và tìm kiếm cơ hội việc làm trong ngành IT cho các bạn sinh viên, đặc biệt là sinh viên nữ. Tham gia IT Fair, người tham gia sẽ có cơ hội kết nối với những người đi trước, từ đó có thể học hỏi và phát triển bản thân trong sự nghiệp';
const featuresTechTalkText = 'Tech Talk được biết đến như là một talkshow dành cho các bạn trẻ có niềm yêu thích về IT. Đến với Tech Talk, các bạn sẽ được nghe những lời chia sẻ về các chủ đề mang tính thời sự về ngành IT, qua đó có cơ hội được đặt câu hỏi cũng như networking với chuyên gia';
const quoteInfoMap = [
  {
